...
class Phone {
    private const PATTERNS = [
        ...
        [
            'prefix' => 882,
            'pattern' => '3(?:(?:(?:2|7\\d{3})\\d|37)\\d\\d|4(?:2|7\\d{3}))\\d{4}',
            'country_code' => '001',
            'example' => '3421234',
            'min_length' => 7,
            'max_length' => 12,
        ...
        [
            'prefix' => 54,
            'pattern' => '54\\d{7}|9(?:11[1-9]\\d{7}|(?:2(?:2[013]|3[067]|49|6[01346]|80|9[147-9])|3(?:36|4[1-358]|5[138]|6[24]|7[069]|8[013578]))[2-9]\\d{6}|(?:2(?:2(?:02|2[13-79]|4[1-6]|5[2457]|6[124-8]|7[1-4]|8[13-6]|9[1267])|3(?:02|1[467]|2[03-6]|3[13-8]|[49][2-6]|5[2-8])|47[3-578]|6(?:2[24-6]|4[6-8]|5[15-8])|9(?:0[1-3]|2\\d|3[1-6]|4[02568]|5[2-4]|6[2-46]|72|8[23]))|3(?:3(?:2[79]|8[2578])|4(?:0[0-24-9]|4[24-7]|6[02-9]|7[126]|9[1-36-8])|5(?:2[1245]|3[237]|4[1-46-9]|6[2-4]|7[1-6]|8[2-5])|7(?:1[1568]|2[15]|3[145]|4[13]|5[14-8]|7[2-57]|8[126])|8(?:2[15-7]|3[2578]|4[13-6]|5[4-8]|6[1-357-9]|9[124])))[2-9]\\d{5})',
            //'pattern' => '^(?=.{15}$)[(]\d{3,5}[)] \d{2,4}-\d{4}$',
            'country_code' => 'AR',
            'example' => '5491164825340',
            'min_length' => 9,
            'max_length' => 16,
        ],
        [
    ...
    private static function getInt($phone) {
        return preg_replace('/[^0-9]/i', '', $phone);
    }

    private static function checkPattern($row, $phone) {
        return preg_match('/'.$row['pattern'].'/i', $phone);
    }


    private static function checkPrefix($row, $phone) {
        $prefix = $row['prefix'];
    ...
    private static function getPhonePattern($phone) {
        $phone =  self::getInt($phone);
        if (!$phone) {
            return false;
        }
        foreach (self::PATTERNS as $row) {
            $length = self::checkLength($row, $phone);
            $prefix = self::checkPrefix($row, $phone);
            $pattern = self::checkPattern($row, $phone);
